      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          <div className="glass-card p-6 rounded-2xl editorial-shadow border border-white/50">
            ...
            <p className="text-3xl font-headline font-black text-primary mb-1">{user?.people.length}</p>
          ...
          <div className="glass-card p-6 rounded-2xl editorial-shadow border border-white/50">
            ...
            <p className="text-3xl font-headline font-black text-primary mb-1">{user?.orders.length}</p>
